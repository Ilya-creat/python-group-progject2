...
def create_session(base_url: str,
    ...
    :param base_url: базовый url-адрес для обращения к API
    :param extra_headers: необходимые заголовки при подключении
    :param use_ssl: использование шифр-тунеллирования
    :param params: необходимая параметризация запроса при подключении
    """
